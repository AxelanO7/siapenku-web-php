import{d as m,i as _,o as l,e as s,b as g,w as B,j as c,k as S,a as e,F as h,h as y,t as n}from"./app-BKVklgcl.js";import E from"./CustomAppLayout-D1_8-cfG.js";import{A as p}from"./auth_helper-C-Aylin_.js";import{C as I}from"./CustomSpinner-Cf_If7Yi.js";import{S as d}from"./sweetalert2.all-BnO6HLk3.js";import"./CustomSidebar-CZelsswH.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const T={key:0,class:"flex justify-center items-center py-8"},D={class:"bg-white rounded-lg shadow-lg mt-4"},M={class:"text-center font-medium text-xl pb-8 pt-4"},N=e("div",{class:"flex items-center px-20 justify-center h-max relative py-6"},[e("img",{src:"/assets/images/kop.png",class:"h-28 w-28 absolute left-20"}),e("div",null,[e("h3",null,"Data Masyarakat Desa Bulian"),e("h3",null,"Kecamatan Kabutambahan"),e("h3",null,"Tahun 2023")])],-1),C=e("hr",{class:"border-2 border-black my-4"},null,-1),P={class:"table-auto w-full text-center border-collapse border border-gray-400"},A={class:"text-center border border-gray-400 px-4 py-2 text-gray-600"},K={class:"text-center border border-gray-400 px-4 py-2 text-gray-600"},L={class:"text-center border border-gray-400 px-4 py-2 text-gray-600"},U={class:"text-center border border-gray-400 px-4 py-2 text-gray-600"},$={class:"text-center border border-gray-400 px-4 py-2 text-gray-600"},R={class:"text-center border border-gray-400 px-4 py-2 text-gray-600"},G={class:"text-center border border-gray-400 px-4 py-2 text-gray-600"},j={class:"text-center border border-gray-400 px-4 py-2 text-gray-600"},F={class:"text-center border border-gray-400 px-4 py-2 text-gray-600"},H={class:"text-center border border-gray-400 px-4 py-2 text-gray-600"},J={class:"text-center border border-gray-400 px-4 py-2 text-gray-600 space-x-4"},V=["onClick"],te={__name:"Resident",setup(O){const x=["No.","NIK","Nama","L/P","Tgl Lahir","Alamat","Status","Pendidikan","No. Telepon","Status Penduduk","Aksi"],i=m(!1),b=m([]),u=async()=>{const t=await p.getBaseUrl();await c.get(`${t}/resident`).then(o=>{const a=o.data.data;b.value=a}).catch(o=>{console.log(o)})},f=()=>{d.fire({title:"Tambah Data",html:`
            <form>
                <div class="mb-4">
